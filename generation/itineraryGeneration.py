...
generationData = Universal.loadGenerationData()
...
def targetLocations():
    ...
    return render_template("generation/targetLocations.html", popularLocations=[x for x in generationData["locations"]])